  ...
  return <section style={{ paddingTop: 24 }}>
    ...
    <div style={{ paddingTop: 6 }}>
      {tab === "activity" && (listened.length === 0 ? <Empty icon="cal" title="No activity yet" body="Albums you log show up here as a running diary." />
        : <div style={{ marginTop: 8 }}>{listened.slice(0, 40).map(a => <Link key={a.album_id} to={`/album/${a.album_id}`} style={{ display: "flex", gap: 12, alignItems: "center", padding: "10px 0", borderBottom: "1px solid var(--line)", textDecoration: "none", color: "var(--ink)" }}>
